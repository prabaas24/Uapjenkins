...
public class Testrunneruap extends Seleniumbase {
    ...
    @Test
    public void uapCreateAssessment() throws Throwable {
        Sleep(5000);
        try {
    ...
    //UAP -- CREATE SCHEDULE
    @Test
    public void uapCreateSchedule() throws Throwable {
        Sleep(10000);
